 ...
 *
 * フィクスチャの描画フォントは同梱サブセット（Noto Sans CJK JP、
 * tests/fixtures/fonts/）に固定されており、環境フォント差でフレークしない。
 * 期待値のマージンは同梱フォントでの CLI パイプライン実測に基づく（Issue #111 記録）:
 *   、 x[69,323] y[-93,152] ／ 。 x[44,331] y[-110,177]
 *   っ 491×380 vs つ 609×465 ／ ぁ 491×515 vs あ 575×616
 *   g/j/p/q/y の yMin -119〜-127 ／ ー 583×59
 */
